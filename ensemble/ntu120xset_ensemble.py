...
wo_k = "xset"  # "xsub" or "xsub_wo_k"

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_path', default=r'D:\templedesk\NTU120_XSet\NTU120_XSet.npz', required=False,
    ...
    if not arg.detail_weight:
        arg.alpha = [1.6, 1.6, 1, 1]
    else:
        # arg.alpha = [2.1, 2.6, 1.3, 0.4]  # 4s 91.7
        arg.alpha = [2.1, 2.6, 1.32, 0.32]  # 4s 91.7
        alpha1 = [1, 1.4, 1, 1]  # joint 89.6
        # alpha2 = [1.3, 0.9, 1, 1]  # bone 89.6
        alpha2 = [1.3, 1.0, 1, 1]
        alpha3 = [1, 1, 0.9, 1]  # joint_motion 86.7
        alpha4 = [1.6, 1.1, 1, 1.3]  # bone_motion 86.1

        # arg.alpha = [1, 1.1, 0, 0]  # 2s 91.0
        # alpha1 = [0.9, 1.4, 1, 1]  # joint 90.0
        # alpha2 = [1.3, 1.0, 1, 1]
