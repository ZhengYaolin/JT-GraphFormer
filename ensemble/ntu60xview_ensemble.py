...
wo_k = "xview"  # "xview" or "xview_wo_k"

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset', default='./gendata/ntu/xview', required=False,
    ...
    parser.add_argument('--detail_weight', default=False, help='use detail weight or not', type=bool)
    ...
    if not arg.detail_weight:
        arg.alpha = [1.5, 1.4, 1.1, 1]
        # arg.alpha = [1, 1, 0, 0] # koopman  2s 97.1
    else:
        arg.alpha = [1, 0, 0, 0] # koopman  joint 96.8
        alpha1 = [1.1, 1, 1, 1]
        alpha2 = [1.1, 1, 1.1, 1]
        alpha3 = [1.2, 1, 1.2, 1.2]
        alpha4 = [1.1, 1.1, 1.1, 1]

        # arg.alpha = [1.2, 1.5, 1, 1]  # koopman  4s 97.5
        # alpha1 = [1, 1, 1, 1.1]
        # alpha2 = [1, 1, 1, 1]
        # alpha3 = [1, 1.1, 1.1, 1]
        # alpha4 = [1, 1, 1, 1]
